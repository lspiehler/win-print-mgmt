...
exports.creds = {
    // Required
    identityMetadata: 'https://login.microsoftonline.com/'+ config.MSFTTENANTGUID +'/v2.0/.well-known/openid-configuration', 
    ...
    clientID: config.MSFTCLIENTID,
  
    // Required if `responseType` is 'code', 'id_token code' or 'code id_token'. 
    // If app key contains '\', replace it with '\\'.
    clientSecret: config.MSFTCLIENTSECRET, 
    ...
    redirectUrl: 'https://' + config.FQDN + '/auth/openid/return', 
    ...
    cookieEncryptionKeys: [ 
      { 'key': config.MSFTCOOKIEKEY1, 'iv': config.MSFTCOOKIEIV1 },
      { 'key': config.MSFTCOOKIEKEY2, 'iv': config.MSFTCOOKIEIV2 }
    ],
  ...
  exports.destroySessionUrl = 'https://login.microsoftonline.com/common/oauth2/logout?post_logout_redirect_uri=https://' + config.FQDN;
